...
from tl.lib.boot import plugin_packages, getpluginlist, boot, getcmndtable, whatcommands
from tl.lib.persist import Persist
from tl.lib.reboot import reboot, reboot_stateful
...
from tl.lib.runner import defaultrunner, cmndrunner, longrunner
from tl.lib.errors import NoSuchPlugin
from tl.utils.statdict import StatDict
...
examples.add("stats", "show stats for all TIMELINE modules/plugins or specify a module/plugin", "1) stats 2) stats rss")
