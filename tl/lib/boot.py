...
from tl.lib.aliases import savealiases
from tl.utils.exception import handle_exception
from tl.lib.datadir import makedirs, getdatadir, touch, homedir
...
default_plugins = ['tl.plugs.core.admin', 'tl.plugs.core.dispatch', 'tl.plugs.core.plug', 'tl.lib.periodical']
...
def savecallbacktable(modname=None):
    ...
    from tl.lib.callbacks import first_callbacks, callbacks, last_callbacks, remote_callbacks
