...
from tl.utils.url import geturl2, striphtml, re_url_match
from tl.utils.generic import splittxt
from tl.utils.timeutils import today
...
from tl.utils.help import ibytes, istr
from tl.lib.periodical import minutely, periodical
...
class OverFlowAPI(object):
    ...
    def timeline(self, target, size=30):
        ...
        try: res = json.loads(json_data)['user_timelines']
        except ValueError as ex: logging.error("can't parse %s" % json_data) ; res = None
        return res
