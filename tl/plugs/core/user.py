...
<name> with userhost from the person giving the command (self merge)', 'user-import feedbackloop@gmail.com')
...
examples.add('user-setemail', 'user-setemail <name> <email>.. set email of user <name>', 'user-setemail owner feedbackflow@gmail.com')
...
examples.add('user-search', 'search users userhosts', 'user-search ggzpreventie.nl')
