...
defaultJID = 'feedbackflow@gmail.com' 
...
examples.add('ask-subjects', 'list all the subjects an expert handles', 'ask-subjects feedbackloop@gmail.com')
