...
class Config(LazyDict):
    ...
    def tofile(self, filename=None, stdout=False):
        ...
        try:
            ...
            configtmp.write('# ===========================================================\n#\n')
            configtmp.write("# TIMELINE CONFIGURATION FILE - %s\n" % filename)
            configtmp.write("#\n")
            configtmp.write('# last changed on %s\n#\n' % time.ctime(time.time()))
            configtmp.write("# This file contains configration data for the TIMELINE.\n")
    ...
    def init(self):
        ...
        if self._filename == 'mainconfig':
            ...
            self.setdefault('appname', "TIMELINE")
...
# last changed on 
#
# This file contains configration data for the TIMELINE.
