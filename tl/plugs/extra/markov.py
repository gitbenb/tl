...
__start__ = ["markov-enable",]
__end__ = ["markov-disable",]

## tl imports

from tl.lib.datadir import getdatadir
from tl.utils.url import geturl, striphtml, geturl2
...
from tl.lib.persist import PersistCollection, Persist
from tl.utils.exception import handle_exception
from tl.utils.name import reversename
...
examples.add('markov-learn', 'learn a logfile or learn an url', '1) markov-learn #dunkbots 2) markov-learn http://ggzpreventie.nl')
...
examples.add('markov-learnadd', 'add channel or url to permanent learning .. this will learn the item on startup', '1) markov-learnadd #dunkbots 2) markov-learnadd http:///docs/tl')
...
examples.add('markov-learndel', 'remove item from learnlist', '1) markov-learndel #dunkbots 2) markov-learndel http:///docs/tl')
