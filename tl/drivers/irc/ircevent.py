...
from tl.utils.generic import toenc, fromenc, strippedtxt, fix_format
...
class IrcEvent(EventBase):
    ...
    def parse(self, bot, rawstr):
        ...
        try:
            ...
            #rawstr = str(rawstr, 'utf-8')
        except TypeError as ex: handle_exception()
        ...
        except IndexError: self.isservermsg = True
        ...
        if self.cmnd in pfc:
            ...
            logging.info("cmnd not in pfc - %s" % rawstr)
        ...
        #else: self.userhost = "server@%s" % bot.cfg.server
